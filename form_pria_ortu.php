<?php
  ...
  session_start();
  $email = $_SESSION["user"];
  $query_ayah = "SELECT * FROM tbl_ayah_pria WHERE email='".$email."'";
  $query_ibu = "SELECT * FROM tbl_ibu_pria WHERE email='".$email."'";
  ...
  if(mysqli_num_rows($result_ayah) == 0 || mysqli_num_rows($result_ayah) == 0){
    $query_insert_ayah = "INSERT INTO tbl_ayah_pria (email) VALUES ('$email')";
    $query_insert_ibu = "INSERT INTO tbl_ibu_pria (email) VALUES ('$email')";
    $insert_ayah = mysqli_query($conn, $query_insert_ayah);
    $insert_ibu = mysqli_query($conn, $query_insert_ibu);
    if($insert_ayah && $insert_ibu){
      header('Location : form_pria_ortu.php');
    }else{
  ...
  if(isset($_POST['save'])){
    ...
    $query_update_ayah = "UPDATE tbl_ayah_pria SET
                      nama='$ayah_nama',
    ...
    $query_update_ibu = "UPDATE tbl_ibu_pria SET
                      nama='$ibu_nama',
