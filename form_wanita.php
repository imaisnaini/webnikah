<?php
  ...
  session_start();
  $email = $_SESSION["user"];
  $query = "SELECT * FROM tbl_wanita WHERE email='".$email."'";
  $result = mysqli_query($conn, $query);
  if(mysqli_num_rows($result) == 0){
    $query_insert = "INSERT INTO tbl_wanita (email) VALUES ('$email')";
  ...
  if(isset($_POST['save'])){
    ...
    $mantan_suami = $_POST['mantan_suami'];

    $query_update = "UPDATE tbl_wanita SET
                      nama='$nama',
                      alias='$alias',
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-light bg-rose navbar-absolute fixed-top ">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-rose">
                  <h4 class="card-title">Data Mempelai Wanita</h4>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="row">
                          <div class="col-md-6"> 
                            <div class="form-group has-info">
                              <label class="bmd-label-floating">Perawan atau janda..</label>
                              <input class="form-control" name="status_kawin" rows="3" value="<?= $row['status_kawin'];?>"/>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group has-info"> 
                              <label class="bmd-label-floating">Nama Suami Terdahulu</label>
                              <input type="text" class="form-control" name="mantan_suami" value="<?= $row['mantan_suami'];?>">
                            </div>
                          </div>
                        </div>
                      </div>
